...
(function(){
  ...
  var META = {
  audiosrt:["🎧 SRT",["#06131f","#0b1019"]],
  stickstories:["🏃 STICK",["#2a1c08","#1a1320"]],
  facelessviral:["🎙️ VIRAL",["#2a0e12","#1a1320"]],
  ariafootball:["⚽ FUTBOL",["#0a2a1f","#0a1a3a"]],
  promojm:["PROMO",["#3a2a10","#1f1633"]],
    mascotashablan:["HABLAN",["#f59e0b","#22c55e"]], audiolibro:["AUDIOLIBRO",["#8b5cf6","#f59e0b"]], leyendaslatam:["LEYENDAS",["#6d28d9","#1f2937"]], diosesmundo:["DIOSES",["#f59e0b","#8b5cf6"]], animalesvida:["SU VIDA",["#22c55e","#0ea5e9"]], objetoshistoria:["OBJETOS",["#d97706","#0ea5e9"]], refranes:["REFRANES",["#f59e0b","#22c55e"]], comidatipica:["COMIDA",["#ef4444","#f59e0b"]], versus:["VERSUS",["#ef4444","#0ea5e9"]], trailerfalso:["TRÁILER",["#1f2937","#f59e0b"]], cuentosclasicos:["CLÁSICOS",["#a855f7","#fbbf24"]], reaccionanimales:["REACCIONES",["#f59e0b","#22d3ee"]], dialogospareja:["PAREJA",["#fb7185","#a855f7"]], terrorpais:["TERROR PAÍS",["#6d28d9","#1f2937"]], vidassantos:["SANTOS",["#fbbf24","#0ea5e9"]], megafauna:["MEGAFAUNA",["#16a34a","#d97706"]], accionepica:["ACCIÓN",["#ef4444","#1f2937"]], mundosfantasia:["FANTASÍA",["#a855f7","#22d3ee"]], bibliakids:["BIBLIA KIDS",["#fbbf24","#0ea5e9"]], idiomaskids:["IDIOMAS",["#22c55e","#f59e0b"]], yogakids:["YOGA KIDS",["#22d3ee","#84cc16"]], seguridadkids:["SEGURIDAD",["#0ea5e9","#ef4444"]], habitoskids:["HÁBITOS",["#84cc16","#f59e0b"]], naturalezakids:["NATURALEZA",["#22c55e","#0ea5e9"]], toursprop:["TOURS",["#0ea5e9","#f59e0b"]], quepasaria:["¿QUÉ SI?",["#6366f1","#22d3ee"]], comosehace:["CÓMO SE HACE",["#f59e0b","#0ea5e9"]], lineatiempo:["TIMELINE",["#d97706","#8b5cf6"]], records:["RÉCORDS",["#ef4444","#f59e0b"]], porquehacemos:["¿POR QUÉ?",["#fb7185","#22d3ee"]], antesdespues:["ANTES/DESPUÉS",["#22c55e","#f59e0b"]], menurest:["MENÚ",["#ef4444","#fbbf24"]],
    canioninfantil:["CANCIONES",["#f472b6","#fbbf24"]], aprendojugando:["APRENDO",["#22c55e","#f59e0b"]], animalitos:["ANIMALITOS",["#f59e0b","#22c55e"]], vehiculos:["VEHICULOS",["#ef4444","#f59e0b"]], cuentohadas:["HADAS",["#a855f7","#f472b6"]], emociones:["EMOCIONES",["#fb7185","#22d3ee"]], modales:["MODALES",["#0ea5e9","#84cc16"]], espacioninos:["ESPACIO KIDS",["#6366f1","#22d3ee"]], granja:["GRANJA",["#84cc16","#f59e0b"]], adivinanzas:["ADIVINANZAS",["#f59e0b","#a855f7"]],
    cuentoviral:["GEMA",["#3a2e10","#241a33"]],
    dormir:["DORMIR",["#10162e","#0e2733"]], microsalud:["MICRO-SALUD",["#2a1320","#0e2a26"]], whiteboard:["WHITEBOARD",["#0e2733","#3a2e10"]], squishmelt:["SQUISH·MELT",["#2a1426","#0e2733"]], asmrreveal:["ASMR REVEAL",["#241a33","#3a2e10"]],
    stickanim:["STICKMAN",["#2a2410","#1f3d2f"]], nightvision:["NIGHT-VISION",["#0e2417","#13301a"]], biomech:["BIOMECH",["#0e2733","#241a33"]], beachsaga:["SAGA SURREAL",["#3a2410","#0e2733"]], evolution:["EVOLUTION",["#0e2733","#2a1320"]], wildbbc:["WILD BBC",["#13301a","#3a2e10"]], cinedirector:["DIRECTOR",["#3a2e10","#2a1320"]],
    animecine:["ANIME",["#1c2740","#2a1f3d"]], animereal:["ANIME+REAL",["#1c2740","#2a1f3d"]], ghibli:["GHIBLI",["#1c2740","#2a1f3d"]], claymation:["PLASTILINA",["#1c2740","#2a1f3d"]], retratopixar:["PIXAR",["#1c2740","#2a1f3d"]], legomundo:["LEGO",["#1c2740","#2a1f3d"]], motioncomic:["WEBTOON",["#1c2740","#2a1f3d"]], pixelart:["PIXEL",["#1c2740","#2a1f3d"]], cartoon2d:["CARTOON",["#1c2740","#2a1f3d"]], futbolepico:["FÚTBOL",["#13301a","#3a2e10"]], extremospov:["POV EXTREMO",["#13301a","#3a2e10"]], animalesdeporte:["ANIMAL PRO",["#13301a","#3a2e10"]], combateepico:["COMBATE",["#13301a","#3a2e10"]], carreras:["CARRERAS",["#13301a","#3a2e10"]], trailersfake:["TRÁILER",["#2a1320","#3a2e10"]], scifi:["SCI-FI",["#2a1320","#3a2e10"]], western:["WESTERN",["#2a1320","#3a2e10"]], noir:["NOIR",["#2a1320","#3a2e10"]], epocahist:["ÉPOCA",["#2a1320","#3a2e10"]], accionhollywood:["ACCIÓN",["#2a1320","#3a2e10"]], cinemudo:["CINE MUDO",["#2a1320","#3a2e10"]], romance:["ROMANCE",["#2a1320","#241a33"]], kdrama:["K-DRAMA",["#2a1320","#241a33"]], telenovela:["TELENOVELA",["#2a1320","#241a33"]], dramaepoca:["DRAMA ÉPOCA",["#2a1320","#241a33"]], quesi:["¿Y SI…?",["#0e2733","#241a33"]], criaturasmito:["MITO REAL",["#0e2733","#241a33"]], kaiju:["KAIJU",["#0e2733","#241a33"]], natimposible:["NAT IMPOSIBLE",["#0e2733","#241a33"]], cosmos:["COSMOS",["#0e2733","#241a33"]], futuro3000:["AÑO 3000",["#0e2733","#241a33"]], postapoc:["POST-APOC",["#0e2733","#241a33"]], microcosmos:["MICRO",["#0e2733","#241a33"]], ugcreview:["UGC",["#2a1335","#10243a"]], testimonios:["TESTIMONIO",["#2a1335","#10243a"]], noticiero:["NOTICIERO",["#2a1335","#10243a"]], standup:["STAND-UP",["#2a1335","#10243a"]], videoclip:["VIDEOCLIP",["#2a1335","#10243a"]], pasarela:["PASARELA",["#2a1335","#241a33"]], lookbook:["LOOKBOOK",["#2a1335","#241a33"]], glowup:["GLOW-UP",["#2a1335","#241a33"]], psicologia:["PSICOLOGÍA",["#0e2733","#13301a"]], estoicismo:["ESTOICISMO",["#0e2733","#13301a"]], ciencia:["CIENCIA",["#0e2733","#13301a"]], espacioedu:["ESPACIO EDU",["#0e2733","#13301a"]], inventos:["INVENTOS",["#0e2733","#13301a"]], foodporn:["FOOD PORN",["#3a2410","#2a1320"]], mukbang:["MUKBANG",["#3a2410","#2a1320"]], recetaspov:["RECETA POV",["#3a2410","#2a1320"]], comidagigante:["GIGANTE",["#3a2410","#2a1320"]], docunatura:["DOCU NAT",["#13301a","#0e2733"]], oceano:["OCÉANO",["#13301a","#0e2733"]], dinosdoc:["DINOS",["#13301a","#0e2733"]], hadasoscuras:["HADAS OSCURAS",["#241a33","#0e2733"]], paranormalpov:["PARANORMAL",["#241a33","#0e2733"]], leyendas:["LEYENDAS",["#241a33","#0e2733"]], viajes:["VIAJES",["#3a2e10","#2a1335"]], supercars:["SUPERCARS",["#3a2e10","#2a1335"]], mansiones:["MANSIONES",["#3a2e10","#2a1335"]], brainrot:["BRAINROT",["#1f3d2f","#2a1335"]],
  ...
  var NICHO={audiosrt:"viralia",stickstories:"viralia",facelessviral:"viralia",ariafootball:"viralia",promojm:"dinero",
    mascotashablan:"viralia",audiolibro:"story",leyendaslatam:"terror",diosesmundo:"story",animalesvida:"story",objetoshistoria:"story",refranes:"cuentos",comidatipica:"viralia",versus:"viralia",trailerfalso:"story",cuentosclasicos:"cuentos",reaccionanimales:"viralia",dialogospareja:"viralia",terrorpais:"terror",vidassantos:"fe",megafauna:"educa",accionepica:"story",mundosfantasia:"story",bibliakids:"infantil",idiomaskids:"infantil",yogakids:"infantil",seguridadkids:"infantil",habitoskids:"infantil",naturalezakids:"infantil",toursprop:"dinero",quepasaria:"educa",comosehace:"educa",lineatiempo:"educa",records:"educa",porquehacemos:"educa",antesdespues:"dinero",menurest:"dinero",
    
    canioninfantil:"infantil",aprendojugando:"infantil",animalitos:"infantil",vehiculos:"infantil",cuentohadas:"infantil",emociones:"infantil",modales:"infantil",espacioninos:"infantil",granja:"infantil",adivinanzas:"infantil",
    
    cuentoviral:"cuentos",
    
    dormir:"asmr",microsalud:"educa",whiteboard:"educa",squishmelt:"asmr",asmrreveal:"asmr",
    
    stickanim:"viralia",nightvision:"viralia",biomech:"viralia",beachsaga:"viralia",evolution:"educa",wildbbc:"educa",cinedirector:"story",
    
    animecine:"cuentos",animereal:"cuentos",ghibli:"cuentos",claymation:"cuentos",retratopixar:"cuentos",legomundo:"cuentos",motioncomic:"cuentos",pixelart:"cuentos",cartoon2d:"cuentos",futbolepico:"viralia",extremospov:"viralia",animalesdeporte:"viralia",combateepico:"viralia",carreras:"viralia",trailersfake:"story",scifi:"story",western:"story",noir:"story",epocahist:"story",accionhollywood:"story",cinemudo:"story",romance:"story",kdrama:"story",telenovela:"story",dramaepoca:"story",quesi:"viralia",criaturasmito:"viralia",kaiju:"viralia",natimposible:"viralia",cosmos:"viralia",futuro3000:"viralia",postapoc:"viralia",microcosmos:"viralia",ugcreview:"podcast",testimonios:"podcast",noticiero:"podcast",standup:"podcast",videoclip:"podcast",pasarela:"viralia",lookbook:"viralia",glowup:"viralia",psicologia:"educa",estoicismo:"educa",ciencia:"educa",espacioedu:"educa",inventos:"educa",foodporn:"asmr",mukbang:"asmr",recetaspov:"asmr",comidagigante:"asmr",docunatura:"educa",oceano:"educa",dinosdoc:"educa",hadasoscuras:"terror",paranormalpov:"terror",leyendas:"terror",viajes:"viralia",supercars:"viralia",mansiones:"viralia",brainrot:"viralia",
    outliers:"analisis",analizador:"analisis",
